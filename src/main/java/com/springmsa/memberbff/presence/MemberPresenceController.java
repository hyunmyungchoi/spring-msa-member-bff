...
public class MemberPresenceController {
    ...
    public ResponseEntity<HeartbeatResponse> heartbeat(HttpServletRequest request, Authentication authentication) {
        return ResponseEntity.ok(memberPresenceService.heartbeat(request.getSession(false), authentication));
    }
}
